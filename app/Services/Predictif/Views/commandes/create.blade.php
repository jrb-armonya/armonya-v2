...
<div class=" col-md-12">
    <div class="card card-shadow mb-4">
        ...
        <div class="card-body">
            <form action="{{ route('generate.command') }}" method="POST" name="generate-file" id="generate-file">
                @csrf
                <input type="text" name="file_name" id="file-name" class="form-control" placeholder="Nom du fichier" required>
                {{-- <strong class="mb-3">{{ $phonesAvailable }}</strong> disponnible --}}
                <div class="mb-3">
                    ...
                    data-grid="true"
                    /> --}}
                    <input type="number" name="nbrPhones" id="">
                </div>
