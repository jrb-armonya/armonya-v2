...
@section('content')
    ...
    <div class="row">
        <div class="col-xl-12">
            ...
            <div class="card card-shadow mb-4" style="border: 1px solid 
                @if($text == 'noValid' ||$text == 'Plateau Non Valid')
                    #f1536e 
                @elseif($text == 'Plateau Valid') 
                    #22ae7a
                @else #4cc3fe @endif;"
            >
                <div class="card-header border-0" style="background-color:
                    @if($text == 'noValid' ||$text == 'Plateau Non Valid')
                        #f1536e 
                    @elseif($text == 'Plateau Valid') 
                        #22ae7a
                ...
                <div class="card-body pt-3 pb-4">
                    ...
                    <div class="table-responsive">
                        ...
                        <table class="table table-bordered table-striped  dataTable" id="fiches-table" cellspacing="0">
                            <thead>
                                <th>id</th>
                                <th>Nom</th>
                                <th>Date</th>
