        ...
        <div class="card card-shadow mb-4">
            ...
            <div class="row">
                <div class="col-xl-6 col-sm-6">
                    <div class='card card-rapports-roles mb-4' style="background-color: #28a745;">
                        <div class="card-body">
                            <div class="media d-flex align-items-center">
                                <div class="media-body text-light">
                                    <h4 class="text-uppercase mb-0 weight500">Moyenne Jour</h4>
                                    <span> {{ $resultat['day'] }} </span>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-xl-6 col-sm-6">
                    <div class='card card-rapports-roles mb-4' style="background-color: #ffa604;">
                        <div class="card-body">
                            <div class="media d-flex align-items-center">
                                <div class="media-body text-light">
                                    <h4 class="text-uppercase mb-0 weight500">Moyenne Mois</h4>
                                    <span> {{ $resultat['month'] }} </span>
                                </div>
                            </div>
                        </div>
                    </div>
