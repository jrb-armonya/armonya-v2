    ...
    <div class="card card-shadow mb-4">
        ...
        <div class="card-header border-0">
            <div class="custom-title-wrap bar-info">
                <div class="custom-title"><h4>Manager <small class="text-muted">Ajouter des Roles a votre application</small></h4></div>
        ...
        <div class="card-body">
            ...
            <div class="row">
                ...
                <div class="col-lg-6">
                    @include('app.roles.tables.index')
                </div>
                
                <div class="col-lg-6">
                    @include('app.roles.forms.create')
                </div>
